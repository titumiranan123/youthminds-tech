    ...
    return (
        <div className='flex justify-center items-center flex-col'>
            <div className='saria flex flex-col  justify-center items-center '>
                ...
                <p className='text-center text-xl w-3/4 text-slate-500'>Services are professional offerings provided by businesses to meet specific needs or solve problems for their customers. Services can range from your budget.</p>
            </div>
