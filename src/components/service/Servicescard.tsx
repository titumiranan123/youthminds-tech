...
const Servicescard: React.FC<proptype> = ({ logo, heading, description }) => {
    ...
    return (
        <div className='flex flex-col gap-10 shadow-lg p-7 border hover:border-orange-500 rounded-3xl h-[28rem] relative'>
            <Image alt='' src={logo} />
            ...
            <button className="btn saria py-4 px-6 bg-orange-400 hover:bg-orange-500 w-1/2 border rounded-bl-3xl rounded-tr-3xl absolute bottom-10">Learn More</button>
        </div>
    );
};
