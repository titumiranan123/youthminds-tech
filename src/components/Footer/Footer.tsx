...
const Footer = () => {
    return (
        <div className='bg-orange-500 bg-opacity-50 '>
            <div className='footer   mt-12 max-w-[1440px] mx-auto p-4'>
                <div className=' text-slate-700  bg-opacity-20 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 pt-6 gap-7'>
                    ...
                    <div className='lg:w-96 lg:ms-20 '>
